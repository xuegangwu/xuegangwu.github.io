...
function seedComponents() {
  ...
  `);
    ...
    const batteryParents = db.prepare("SELECT id, brand FROM components WHERE type = 'battery'").all();
    const pcsParents = db.prepare("SELECT id, brand FROM components WHERE type = 'pcs'").all();
    const bmsParents = db.prepare("SELECT id, brand FROM components WHERE type = 'bms'").all();
